                ...
                if(json.length > 0){
                    $.each(json.reverse(), function(index){
                        ...
                        if(user.uname == payload.uname){
                            ...
                            cell2.innerHTML = (payload.profit>0?parseFloat(parseFloat(parseFloat(payload.profit)/parseFloat(payload.wager)).formatMoney(2, '.', ','))+"x":(parseFloat(payload.profit)==0?1+"x":(payload.profit*-1>0?parseFloat(parseFloat(parseFloat(payload.profit*-1)/parseFloat(payload.wager)).formatMoney(2, '.', ','))+"x":0+"x")));
                        ...
                        cell3.innerHTML = (payload.profit>0?parseFloat(parseFloat(parseFloat(payload.profit)/parseFloat(payload.wager)).formatMoney(2, '.', ','))+"x":(parseFloat(payload.profit)==0?1+"x":(payload.profit*-1>0?parseFloat(parseFloat(parseFloat(payload.profit*-1)/parseFloat(payload.wager)).formatMoney(2, '.', ','))+"x":0+"x")));
...
function SPIN(number){
    var $r = $('.wheel-active img').fortune({prices: wheels[currentWheel]});
    console.log("[DEBUG] NUMBER TO SPIN:", number,"| Amount:", wheels[currentWheel].length);
    number = parseFloat(parseInt(number)-4.5);
