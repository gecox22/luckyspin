            ...
            if(json.length > 0){
                $.each(json.reverse(), function(index){
                    ...
                    if(user.uname == payload.uname){
                        ...
                        cell2.innerHTML = (payload.profit>0?parseFloat(parseFloat(parseFloat(payload.profit)/parseFloat(payload.wager)).formatMoney(2, '.', ','))+"x":(parseFloat(payload.profit)==0?1+"x":0+"x"));
                    ...
                    cell3.innerHTML = (payload.profit>0?parseFloat(parseFloat(parseFloat(payload.profit)/parseFloat(payload.wager)).formatMoney(2, '.', ','))+"x":(parseFloat(payload.profit)==0?1+"x":0+"x"));
