...
$(function(){
    ...
    socket.on('new_bet', function(payload) {
        if(user.uname == payload.uname){
            ...
            cell2.innerHTML = (payload.profit>0?parseFloat(parseFloat(parseFloat(payload.profit)/parseFloat(payload.wager)).formatMoney(2, '.', ','))+"x":(payload.profit==payload.wager?1+"x":0+"x"));
            cell2.className = (payload.profit>1?"table-result up":(payload.profit<1?"table-result down":"table-result equal"));
        ...
        cell3.innerHTML = (payload.profit>0?parseFloat(parseFloat(parseFloat(payload.profit)/parseFloat(payload.wager)).formatMoney(2, '.', ','))+"x":(payload.profit==payload.wager?1+"x":0+"x"));
        cell3.className = (payload.profit>1?"table-result up":(payload.profit<1?"table-result down":"table-result equal"));
