            ...
            if(json.length > 0){
                $.each(json.reverse(), function(index){
                    ...
                    if(user.uname == payload.uname){
                        ...
                        cell2.className = (parseFloat(payload.profit)>1?"table-result up":(parseFloat(payload.profit)<1?"table-result down":(parseFloat(payload.profit)==0?"table-result equal":"table-result down"));
                    ...
                    cell3.className = (parseFloat(payload.profit)>1?"table-result up":(parseFloat(payload.profit)<1?"table-result down":(parseFloat(payload.profit)==0?"table-result equal":"table-result down"));
