...
$(function(){
    ...
    $('#50p').click(function(){
        $('#wager-result').val((parseFloat($('#wager-result').val()) * 0.5).formatMoney(2,'.',','));
    });
    $('#2x').click(function(){
        $('#wager-result').val((parseFloat($('#wager-result').val()) * 2).formatMoney(2,'.',','));
    });
    $('#min').click(function(){
        $('#wager-result').val(((parseFloat($('.balance-result').val())>=1?1:0)).formatMoney(2,'.',','));
    });
    $('#max').click(function(){
        $('#wager-result').val(parseFloat($('.balance-result').text()).formatMoney(2,'.',','));
    });
});
